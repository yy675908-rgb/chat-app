...
""",
    'assembled intimacy instruction',
)
...
""",
    ...
    if (selectedId == '__groups__') {
""",
    'character delete selection',
)

create_character = """  Future<void> _createCharacter() async {
...
replace_once(
    ...
    'character delete implementation',
)
...
""",
    'intimacy behavior mapping',
)

path.write_text(text, encoding='utf-8')
print('Applied agent source changes successfully.')
